...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        {
            \draw({\x/2},0)rectangle({\x/2+.25},3);
            \draw[fill=gray]({\x/2+.25},0)rectangle({\x/2+.5},3);
            \draw({\x/2+4},0)rectangle({\x/2+4+.25},3);
            \draw[fill=gray]({\x/2+4+.25},0)rectangle({\x/2+4+.5},3);
        };
        \draw[<->, >=Stealth](2,1.5)--(4,1.5);
        \node at(3,1.5)[anchor=south]{$D$};
    \end{tikzpicture}
    \caption{多層膜ミラーの構造}
