...
//const Int_t kp_ch = 0 ;
const Int_t kp_ch = 3 ; //for temporaly test 20231211
const Int_t tp_ch = 1;
const Int_t up_ch = 2;
const Int_t num_kps = 3;
const Int_t num_tps = 2;
const Bool_t multi_kp = 1;
Int_t kp_chs[num_kps] = {0,3,4};
Int_t tp_chs[num_tps] = {1,5};
Int_t ch_flag = -1; // 0: kp, 1: tp, 2: up
const Int_t next_pulse = (Int_t) (repitition/timebin * 0.99); //39.6 ms

const Int_t kp_LLD = 512;
const Int_t kp_HLD = 8190;
const Int_t monitor_thr = 150;
const Int_t rpmt_LLD_FRP = 200; //for FRP
const Int_t rpmt_HLD_FRP = 7400; //for FRP
Int_t rpmt_LLD = 200; // for RMPT
Int_t rpmt_HLD = 8200; // for RPMT
...
Int_t DrawNikiPMTs(char* DataFileName);
