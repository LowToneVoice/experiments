...
double OpenGVTime         = 100000000;
double ImportTime         = 50000000;
double StorageTime1       = 40000000;
double StorageTime2       = 80000000;
double StorageTime3       = 120000000;
double StorageTime4       = 160000000;
...
i++;
start=clock();
StorageTime = (j==0)?StorageTime1:(j==1)?StorageTime2:(j==2)?StorageTime3:StorageTime4;
