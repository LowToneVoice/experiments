...
double ImportTime         = 10000000;
double StorageTime1       = 30000000;
double StorageTime2       = 30000000;
double StorageTime3       = 30000000;
double StorageTime4       = 30000000;
double StorageTime5       = 30000000;
...
if(argc==2){
printf("argv[1]=%s\n",argv[1]);
ImportTime         = (int)(atof(argv[1])*1e6);
printf("ImportTime=%e\n",ImportTime);
}
