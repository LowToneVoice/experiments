...
double StorageTime3       = 65 * 1000000;
double StorageTime4       = 85 * 1000000;
double StorageTime5       = 105 * 1000000;
...
FILE *fp;
if((fp=fopen("log2021.dat","w"))==NULL){
...
i++;
start=clock();
StorageTime = (j==0)?StorageTime1:(j==1)?StorageTime2:(j==2)?StorageTime3:(j==3)?StorageTime4:(j==4?)StorageTime5:(j==5?)StorageTime6;
